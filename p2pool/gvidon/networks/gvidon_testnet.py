...
RPC_CHECK = defer.inlineCallbacks(lambda gvidond: defer.returnValue(
            ...
            (yield gvidond.rpc_getinfo())['testnet']
        ))
...
BLOCK_EXPLORER_URL_PREFIX = 'https://test.explorer.gvidon.org/block/'
ADDRESS_EXPLORER_URL_PREFIX = 'https://test.explorer.gvidon.org/address/'
TX_EXPLORER_URL_PREFIX = 'https://test.explorer.gvidon.org/tx/'
