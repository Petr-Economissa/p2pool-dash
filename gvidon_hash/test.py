...
# gvidon block #1
# moo@b1:~/.gvidon$ gvidond getblockhash 1
# 000007d91d1254d60e2dd1ae580383070a4ddffa4c64c2eeb4a2f9ecc0414343
# moo@b1:~/.gvidon$ gvidond getblock 000007d91d1254d60e2dd1ae580383070a4ddffa4c64c2eeb4a2f9ecc0414343
# {
...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_gvidon_hash(self):
        self.pow_hash = hexlify(gvidon_hash.getPoWHash(self.block_header))
