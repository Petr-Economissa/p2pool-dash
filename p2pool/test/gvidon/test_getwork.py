...
from p2pool.gvidon import getwork, data as gvidon_data
    ...
    def test_all(self):
        ...
        case2s = [
            getwork.BlockAttempt(
                ...
                1305759879,
                gvidon_data.FloatingInteger.from_target_upper_bound(0x44b9f20000000000000000000000000000000000000000000000),
